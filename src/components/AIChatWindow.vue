...
const initialY = typeof window !== 'undefined' ? window.innerHeight - 500 : 0;
...
<template>
  <div ref="chatWidget" class="chat-widget" :style="style">
    <div ref="chatHeader" class="chat-header" :style="{ cursor: isDragging ? 'grabbing' : 'grab' }">
      AI Form Assistant
    </div>
